...
type productItemType ={
 ...
 function index({item, addItemToCart}: productItemType) {
  ...
  return (
   <TouchableOpacity 
   onPress={() => navigator.navigate("ProductDetails", {product:item})}
   style={{
    width: width *0.28,
    marginTop:12,
    height: height * 0.25,
    ...
    <Image
     ...
     style={{width:width * 0.28, height:width * 0.28, borderRadius:12, borderWidth:0.1, borderColor:'gray'}}
     />
     ...
     <TouchableOpacity onPress={() => addItemToCart(item)}
      style={{
      alignItems:'center', justifyContent:'center', shadowRadius:3.8, shadowOpacity:0.05,
      width:30, height:30, borderWidth:0.3, borderColor:"lightgrey", backgroundColor:'white', position:'absolute', right:-6, top:-6, borderRadius:6}}>
